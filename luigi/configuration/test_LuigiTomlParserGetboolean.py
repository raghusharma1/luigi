...
class Test_LuigiTomlParserGetboolean:
    ...
    def test_getboolean_with_existing_section_and_option(self):
        # Arrange
        parser = LuigiTomlParser({'section1': {'option1': 'true'}})
        expected_value = True

        # Act
        actual_value = parser.getboolean('section1', 'option1')
    ...
    def test_getboolean_with_existing_section_and_missing_option(self):
        ...
        # Act
        actual_value = parser.getboolean('section1', 'option2', default=default_value)
    ...
    def test_getboolean_with_missing_section_and_option(self):
        ...
        # Act
        actual_value = parser.getboolean('section2', 'option2', default=default_value)
    ...
    def test_getboolean_with_missing_option_no_default(self):
        ...
        with pytest.raises(KeyError):
            parser.getboolean('section1', 'option2')
