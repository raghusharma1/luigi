...
import toml
from toml_parser import __getitem__
...
class Test_LuigiTomlParserGetitem:
    ...
    def test_getitem_return_value_type(self):
        ...
        instance = __getitem__(data)
        assert isinstance(instance["key1"], int)
        assert isinstance(instance["key2"], int)
        assert isinstance(instance["key3"], int)
