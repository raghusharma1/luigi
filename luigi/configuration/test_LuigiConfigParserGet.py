...
class Test_LuigiConfigParserGet:
    ...
    def test_get_option_with_underscore(self):
        ...
        luigi_config = BaseParser(config)
        assert luigi_config.get('test_section', 'test_option') == 'test_value'
    ...
    def test_get_option_with_dash(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert luigi_config.get('test-section', 'test-option') == 'test-value'
            assert len(w) == 1
    ...
    def test_get_no_option(self):
        ...
        with pytest.raises(NoOptionError):
            luigi_config.get('test_section', 'nonexistent_option')
    ...
    def test_get_mismatched_default_type(self):
        ...
        with pytest.raises(TypeError):
            luigi_config.get('test_section', 'test_option', default=1)
